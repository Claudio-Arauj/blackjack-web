...
export const getPathId = (idName) => {
  return pathData?.[idName] || null; // Verifica o tipo e o idName, retornando o valor ou null
};
...
//dados para construir a pagina sobre
export const sobrePageData = {
    sobre: {
      projeto: {
...
//dados para construir a pagina como_jogar
export const tutorialPageData = {
  tutorial: {
    blackjack: {
        ...
        Em cada rodada, ambos viram a carta do topo de seu monte,
         e quem tiver a carta de maior valor ganha um ponto.
          Em caso de empate (mesmo valor),
           ninguem ganha ponto. O jogo continua até que passe 6 rodadas.`,
      path: "/war_menu"
    },
  }
}  